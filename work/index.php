...
<head>
	...
	<title>Erfolgreiches Webdesign und Online-Marketing | localmedia Referenzen</title>
...
<link rel='stylesheet' id='lmCSS-css'  href='../wp-content/themes/localmedia-wp-theme/bedrock/app/assets/css/app-0f8ab4bf7a.css' media='all' />
	...
	<body id="body" class="page-template page-template-page-templates page-template-page-work page-template-page-templatespage-work-php page page-id-514 work" data-page="Work">
        ...
        <div class="cover-container">
            <div class="cover-container-content bumba">
                <h1 class="cover-headline word--up--cover">
                    Websites, Online-Marketing, Filme oder Raumschiffe.                </h1>
                                                    <p class="cover-lead lead text--gray fade--up--cover">Let’s talk & create something awesome.</p>
                            </div>
        </div>
...
<div class="page-section page-section--work trigger--end">
    ...
    <div class="work-item__caption real-line--up">
        ...
        <div class="work-item__client text--small text--gray">AuraVita Fitness-Center - Rapperswil</div>
    </div>
</a>
                </div>
                </div>
